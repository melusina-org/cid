;;;; setup.lisp — Project setup for El Cid
...
(setf org.melusina.atelier:*parameter-bindings*
	...
	(:project-description . "Count of Vivar and Prince of Continuous Integration and Deployment Systems")
        (:project-long-description . "The **El Cid** project aims at providing a complete continuous integration and deployment system that is easy to incrementally improve, to share with team mates and collaborators, and that can be deployed easily either locally, on bare metal or in the cloud.")
